            ...
            <div className="w-full h-screen bg-[#212121] flex justify-center items-center">
                <div className="flex flex-col justify-center items-center md:flex-row">
                    ...
                    <div className="text-white flex flex-col justify-center items-center md:items-start gap-4">
                        ...
                        <p className="text-[clamp(10px,2vw,16px)]">The Page you are looking for doesn't exist or an other occurred. <br /> Go back, or head over to <Link to="/">Home</Link> to choose a new direction.</p>
                    </div>
                </div>
            </div> 
        </>
